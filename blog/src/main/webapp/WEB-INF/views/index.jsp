    			...
    			<div class="row fullscreen align-items-center justify-content-start">
    				<div class="col-lg-12">
    					<div class="active-banner-slider owl-carousel">
    						<!-- single-slide -->
    						<div class="custom-shape-divider-bottom-1653352073">
    						...
    						<div class="row single-slide align-items-center d-flex">
    							<div class="col-lg-5 col-md-6-lotation">
    								<div class="banner-content">
    									<h1>TWOHAND<br>Collection</h1><br>
    								</div>
    							</div>
    						</div>
    						</div>
    			...
    			<div class="row features-inner">
    				...
    				<div class="col-lg-3 col-md-6 col-sm-6">
    					<div class="single-features">
    						...
    						<h6>World Wide</h6>
    						<p>Contact all around the world</p>
    					</div>
    				</div>
    				<!-- single features -->
    				<div class="col-lg-3 col-md-6 col-sm-6">
    					<div class="single-features">
    						...
    						<h6>Contact us</h6>
    						<p>24 / 7 Support on our market</p>
    					</div>
    				</div>
    				<!-- single features -->
    				<div class="col-lg-3 col-md-6 col-sm-6">
    				...
    				<div class="col-lg-3 col-md-6 col-sm-6">
    					<div class="single-features">
    						...
    						<h6>Secure Policy</h6>
    						<p>Roles when selling or buying</p>
    					</div>
    				</div>
    			</div>
    		</div>
